 ...
 * useragent.js
 * version: 1.0.0
 * build: Wed Feb 18 2015 14:02:11 GMT+0800 (中国标准时间)
...
(b.platform=b.os);return b}},g=function(a,b,c,e){a.osDetect=b;a.deviceDetect=c;a.browserDetect=e};"undefined"!==typeof module&&module.exports?(g(b,require("./lib/os"),require("./lib/device"),require("./lib/browser")),module.exports=b):a?define(["./lib/os","./lib/device","./lib/browser"],function(a,e,c){g(b,a,e,c);console.log(b);return b}):e?define(function(a,e,c){g(b,a("./lib/os"),a("./lib/device"),a("./lib/browser"));c.exports=b}):("undefined"!==typeof USERAGENT_OS&&(b.osDetect=new USERAGENT_OS),
"undefined"!==typeof USERAGENT_DEVICE&&(b.deviceDetect=new USERAGENT_DEVICE),"undefined"!==typeof USERAGENT_BROWSER&&(b.browserDetect=new USERAGENT_BROWSER),h.USERAGENT=b)})(this);
